...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    private static final Color WINDOW_BACKGROUND_COLOR = Color.rgb(102, 153, 255);
    private static final Color BOARD_BACKGROUND_COLOR = Color.rgb(255, 204, 204);
    private static final String SUDOKU = "Sudoku Puzzle";
